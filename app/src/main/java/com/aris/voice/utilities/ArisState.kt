...
/**
 * Represents the different states of the Aris app for visual feedback
 */
enum class ArisState {
    /**
    ...
    /**
     * App is dizzy and knocked out by a double tap with visual stars spinning around its head
     */
    DIZZY
}
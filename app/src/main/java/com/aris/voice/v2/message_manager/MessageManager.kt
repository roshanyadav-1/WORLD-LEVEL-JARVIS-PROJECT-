package com.aris.voice.v2.message_manager

import android.content.Context
import com.aris.voice.v2.ActionResult
import com.aris.voice.v2.AgentOutput
import com.aris.voice.v2.AgentSettings
import com.aris.voice.v2.AgentStepInfo
import com.aris.voice.v2.ScreenState
import com.aris.voice.v2.SystemPromptLoader
import com.aris.voice.v2.UserMessageBuilder
...
class MemoryManager(
    ...
    fun createStateMessage(
        ...
        try {
            ...
            state.history.contextMessages.clear()  // only clear context on success
        } catch (e: Exception) {
            android.util.Log.e("MemoryManager", "Failed to build state message", e)
            // contextMessages is NOT cleared so agent can receive correcting message
        }
    }

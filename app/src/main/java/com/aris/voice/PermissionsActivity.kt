...
class PermissionsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val backButton: android.view.View = findViewById(R.id.backButtonPermissions)
        ...
        grantOverlayButton.setOnClickListener {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                try {
                    ...
                    Toast.makeText(this@PermissionsActivity, "Settings not available on this device.", Toast.LENGTH_SHORT).show()
                }
            }
        }
